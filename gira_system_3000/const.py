...
SENSOR_TEMP_SIGN_THRESHOLD = 0x8000
SENSOR_TEMP_NEG_BASE = 0x8000
SENSOR_TEMP_DIVISOR = 100.0

SENSOR_LUX_A = 0.00015070156043542327
SENSOR_LUX_B = 0.9468552783240188

SENSOR_TEMPERATURE_SCALE = 0.01  # raw / 100 -> °C
SENSOR_BRIGHTNESS_SCALE  = 1.0   # raw -> lux (assumption)
